...
def Uresidual_block(inputs, channels, name):
    ...
    up_2_2 = tf.keras.layers.Conv2DTranspose(
                 channels,
                 (2,2),
                 padding='same')(res1_1)
    up_4_4 = DecoderMiniBlock(up_2_2, res2_2, channels)
    up_8_8 = DecoderMiniBlock(up_4_4, res4_4, channels)
    


    out = squeeze_excitation(batch_norm(conv2,
                                                    name + '/2/bn',
                                                    scale=True),
                                    channels,
                                    name=name + '/se')
