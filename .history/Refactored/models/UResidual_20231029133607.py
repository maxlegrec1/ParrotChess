...
def DecoderMiniBlock(prev_layer_input, skip_layer_input, n_filters=64, kernel_size = (3,3)):
...
def Uresidual_block(inputs, channels, name):
    ...
    res1_1 = tf.keras.layers.Conv2D(channels,
                                    ...
                                    name=name + '/1_1/conv2d')(res4_4)
    res1_1 = tf.keras.layers.Activation('relu')(
        batch_norm(res1_1, name + '/1_1/bn', scale=False))
    
    up_2_2 = DecoderMiniBlock(res1_1, res2_2, channels, kernel_size=(2,2))
    up_4_4 = DecoderMiniBlock(up_2_2, res4_4, channels, kernel_size=(3,3))
    up_8_8 = DecoderMiniBlock(up_4_4, inputs, channels, kernel_size=(5,5))
